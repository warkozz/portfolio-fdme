        ...
        <div className="max-w-5xl mx-auto grid grid-cols-1 md:grid-cols-5 gap-6">
          ...
          <div className="md:col-span-2 bg-white dark:bg-gray-800 rounded-2xl shadow-soft p-6">
            <div className="flex items-center gap-2 mb-4">
              ...
              <h1 className="text-3xl font-extrabold text-gray-900 dark:text-white">Contact</h1>
            </div>
          ...
          <div className="md:col-span-3 bg-white dark:bg-gray-800 rounded-2xl shadow-soft p-6">
            ...
            <form onSubmit={formik.handleSubmit} className="grid grid-cols-1 gap-4">
              ...
              <div className="flex items-center gap-3">
                <button type="submit" disabled={status.type === 'loading'} className="inline-flex items-center gap-2 bg-primary-600 hover:bg-primary-700 disabled:opacity-70 disabled:cursor-not-allowed text-white px-4 py-2 rounded-lg font-medium">

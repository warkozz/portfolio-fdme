    ...
    <footer className="border-t border-gray-200 dark:border-gray-800 bg-white/50 dark:bg-gray-900/50 backdrop-blur">
      <div className={`container ${containerClasses[containerSize]} px-4 sm:px-6 lg:px-8 flex flex-col md:flex-row items-center justify-between py-6 text-sm`}>
        <div className="text-gray-600 dark:text-gray-400">
          © {new Date().getFullYear()} <span className="font-semibold text-gray-800 dark:text-gray-200">Portfolio Rayane</span> – Tous droits réservés
        </div>
        <div className="flex gap-6 mt-3 md:mt-0">
          ...
          >
            <div className="relative">
              ...
              <span className="absolute inset-0 rounded-full bg-gray-900 dark:bg-white opacity-0 group-hover:opacity-10 transition-opacity duration-200"></span>
            </div>
          ...
          >
            <div className="relative">
              ...
              <span className="absolute inset-0 rounded-full bg-blue-600 opacity-0 group-hover:opacity-10 transition-opacity duration-200"></span>
            </div>
          ...
          >
            <div className="relative">
              ...
              <span className="absolute inset-0 rounded-full bg-primary-600 opacity-0 group-hover:opacity-10 transition-opacity duration-200"></span>
            </div>

...
$stmt = $pdo->prepare('INSERT INTO projects (title, description, image, github_link, competencies, category) VALUES (?, ?, ?, ?, ?, ?)');
$stmt->execute([$title, $description, $image, $github_link, $competencies, $category]);

...
$stmt = $pdo->prepare('UPDATE projects SET title=?, description=?, image=?, github_link=?, competencies=? WHERE id=?');
$stmt->execute([$title, $description, $image, $github_link, $competencies, $id]);
